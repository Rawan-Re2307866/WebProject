...
export default function Login() {
    ...
    async function handleSubmit(e) {
        ...
        if (!usernameValid.test(username)) {
            setUsernameError("Username must start with a letter and be between 3-20 characters only.");
            isValid = false;
        }

        const passwordValid = /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*()\-+.])[a-zA-Z0-9!@#$%^&*()\-.+]{8,30}$/;
        if (!passwordValid.test(password)) {
            setPasswordError("Password must be 8+ characters, 1 uppercase, 1 lowercase, 1 digit, 1 special char.");
            isValid = false;
        }
        ...
        <div className="login-body">
            <header>
                <section className="login-header">
                    <img src="/images/logo.png" alt="AR^2 logo" />
                </section>
            </header>
                    ...
                    <form className="login-form" onSubmit={handleSubmit}>
                        ...
                        <div className="password-container">
                            ...
                            <button
                                ...
                                {!showPassword ? (
                                    <svg className="eye-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="20" height="20">
